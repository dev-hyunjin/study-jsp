        ...
        <section id="info-wrap">
            <article id="info-container">
                ...
                <section class="move-page">
                    <a href="javascript:location.href='${pageContext.request.contextPath}/board/listOk.board?page=${page}&sort=${sort}&type=${type}&keyword=${keyword}'">목록으로</a>
...
<script>
	...
	let page = `${page}` || null, type = `${type}` || null, keyword = `${keyword}` || '', sort = `${sort}`;
	let boards = `${boards}`;
</script>
